...
public class MovieToPortfolio {
    ...
    public MovieToPortfolio(Long movie_id, String username, String identifier, String title, String release_date, String description, int is_favourite) { //constructor
